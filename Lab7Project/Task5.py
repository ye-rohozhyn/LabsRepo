...
sum_between_values, count_between_values = calculate_sum_and_count_between(result_array, a_value, b_value)
print(f"Sum of values between {a_value} and {b_value}: {sum_between_values}")
print(f"Count of values between {a_value} and {b_value}: {count_between_values}")
